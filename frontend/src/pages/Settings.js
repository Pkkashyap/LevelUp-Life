...
import { Plus, Trash2, Palette, Award, Target } from 'lucide-react';
...
const Settings = () => {
  ...
  const iconOptions = ['Star', 'Trophy', 'Award', 'Crown', 'Flame', 'Target', 'Zap', 'Heart'];
  const badgeIcons = ['Trophy', 'Star', 'Award', 'Crown', 'Flame', 'Footprints', 'Medal', 'Shield'];
        ...
        <TabsContent value=\"badges\">
          ...
          >
            <Button
              ...
              className=\"bg-secondary text-white border-2 border-black shadow-brutal hover:shadow-brutal-sm hover:translate-x-[2px] hover:translate-y-[2px] transition-all font-bold\"
              data-testid=\"add-badge-btn\"
            >
              <Plus size={20} className=\"mr-2\" />
              Create Custom Badge
            </Button>
                  ...
                  <form onSubmit={handleBadgeSubmit} className=\"space-y-4\">
                    <div>
                      ...
                      <Input
                        ...
                        placeholder=\"e.g., Marathon Master, Study Guru\"
                        className=\"border-2 border-black\"
                    ...
                    <div>
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => setBadgeFormData({ ...badgeFormData, icon: value })}
                      >
                    ...
                    <div>
                      ...
                      <Select 
                        value={badgeFormData.condition_type} 
                        onValueChange={(value) => setBadgeFormData({ ...badgeFormData, condition_type: value })}
                      >
                        <SelectTrigger className=\"border-2 border-black\">
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div>
                      ...
                      <Input
                        id=\"condition-value\"
                        type=\"number\"
                        value={badgeFormData.condition_value}
                        onChange={(e) => setBadgeFormData({ ...badgeFormData, condition_value: parseInt(e.target.value) })}
                        placeholder=\"e.g., 50\"
                        className=\"border-2 border-black\"
                    ...
                    <div className=\"flex gap-3\">
                      <Button
                        type=\"submit\"
                        className=\"flex-1 bg-secondary text-white border-2 border-black shadow-brutal hover:shadow-brutal-sm hover:translate-x-[2px] hover:translate-y-[2px] transition-all font-bold\"
                        data-testid=\"submit-badge-btn\"
                      >
                        Create Badge
                      </Button>
                      <Button
          ...
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4\">
            {badges.map((badge, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.05 }}
                className=\"bg-white p-6 rounded-xl border-2 border-black shadow-brutal hover:shadow-brutal-sm hover:translate-x-[2px] hover:translate-y-[2px] transition-all\"
                data-testid={`badge-settings-card-${index}`}
              >
                <div className=\"flex items-start justify-between mb-3\">
                  ...
                  {badge.id.includes('custom') && (
                    <Button
                      ...
                      variant=\"destructive\"
                      size=\"icon\"
                      className=\"border-2 border-black shadow-brutal hover:shadow-brutal-sm hover:translate-x-[2px] hover:translate-y-[2px] transition-all h-8 w-8\"
                    >
                      <Trash2 size={14} />
                    </Button>
                  )}
                ...
                <div className=\"flex items-center gap-2 text-xs\">
                  <span className={`px-2 py-1 rounded-full border-2 border-black font-bold ${
                    badge.id.includes('custom') ? 'bg-secondary/20 text-secondary' : 'bg-primary/20 text-primary'
                  }`}>
